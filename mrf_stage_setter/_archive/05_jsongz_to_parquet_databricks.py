...
Usage in Databricks:
    %run ./commands/05_jsongz_to_parquet_databricks
"""
...
LOG = logging.getLogger("commands.jsongz_to_parquet_databricks")
...
# Dimension tables: Set to True to create dimension tables and normalize fact table (default)
# Set to False to skip dimension table creation for faster processing
create_dim_tables = parquet_cfg.get("create_dimension_tables", True)
